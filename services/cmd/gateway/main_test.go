...
func TestSTART19RequiredPermissionClassification(t *testing.T) {
	tests := []struct {
		...
		{http.MethodPut, "/api/v1/billing/partners/ptr_1/agreement", "billing.approve"},
		{http.MethodGet, "/api/v1/billing/partners/ptr_1/commercial-status", "billing.read"},
		{http.MethodPut, "/api/v1/connectors/ptr_1/website-adapter", "connectors.write"},
