...
class HimateI18n {
  ...
  static const Map<String, String> _literalHu = <String, String>{
    ...
    'Paid YTD': 'Idén fizetve',
    'Pending onboarding': 'Függőben lévő onboarding',
    'Registration → review → approval': 'Regisztráció → ellenőrzés → jóváhagyás',
    'Paid revenue · last 12 months': 'Fizetett bevétel · elmúlt 12 hónap',
    'Invoice approval queue': 'Számlajóváhagyási sor',
    'Draft → Approved → Sent → Paid / Cancelled. Collection is blocked until the invoice is Sent.': 'Piszkozat → Jóváhagyva → Elküldve → Fizetve / Törölve. A terhelés az elküldésig blokkolt.',
    'No invoices in this state': 'Nincs számla ebben az állapotban',
    'Create a manual draft or wait for the recurring billing cycle to generate a new draft.': 'Készíts kézi piszkozatot, vagy várd meg, amíg az ismétlődő számlázási ciklus új piszkozatot generál.',
    'Partner onboarding': 'Partner onboarding',
    'Registered → Pending Review → Classified → invoice/payment or documented support → Admin Approval → Active.': 'Regisztrált → Ellenőrzésre vár → Besorolt → számla/fizetés vagy dokumentált támogatás → Admin jóváhagyás → Aktív.',
    'No pending onboarding': 'Nincs függőben lévő onboarding',
    'All current partner registrations have completed the Central-6 commercial approval lifecycle.': 'Minden jelenlegi partnerregisztráció teljesítette a Central-6 kereskedelmi jóváhagyási folyamatát.',
    'Create invoice draft': 'Számlapiszkozat létrehozása',
    'Manual invoices are always created as DRAFT. Approval is required before sending or collecting payment.': 'A kézi számlák mindig PISZKOZAT állapotban jönnek létre. Küldés vagy terhelés előtt jóváhagyás szükséges.',
    'Net amount': 'Nettó összeg',
    'Currency': 'Pénznem',
    'Service period start': 'Szolgáltatási időszak kezdete',
    'Service period end': 'Szolgáltatási időszak vége',
    'Due date': 'Fizetési határidő',
    'Approve invoice': 'Számla jóváhagyása',
    'Send invoice': 'Számla elküldése',
    'Mark paid': 'Fizetettnek jelölés',
    'Cancel invoice': 'Számla törlése',
    'Reason / note': 'Indok / megjegyzés',
    'Classify partner': 'Partner besorolása',
    'Commercial classification': 'Kereskedelmi besorolás',
    'Sponsored': 'Szponzorált',
    'Classification note': 'Besorolási megjegyzés',
    'Support / waiver reason': 'Támogatás / mentesség indoka',
    'Nominal supported value': 'Támogatás névleges értéke',
    'Evidence reference': 'Bizonyíték hivatkozása',
    'Start review': 'Ellenőrzés indítása',
    'Classify': 'Besorolás',
    'Create invoice': 'Számla létrehozása',
    'Send to approval': 'Jóváhagyásra küldés',
    'Activate partner': 'Partner aktiválása',
    'Approve': 'Jóváhagyás',
    'Send': 'Küldés',
    'Open PDF': 'PDF megnyitása',
    'Portal access': 'Portál-hozzáférés',
    'Blocked until Active': 'Aktív állapotig blokkolva',
    'Central-6 Finance Rules': 'Central-6 pénzügyi szabályok',
    'Partner activation': 'Partner aktiválás',
    'Final HIMATE approval required': 'Végső HIMATE jóváhagyás szükséges',
    'Invoice lifecycle': 'Számla életciklus',
    'Payment collection': 'Fizetési terhelés',
    'Blocked until Sent': 'Elküldött állapotig blokkolva',
    'Partner visibility': 'Partner láthatóság',
    'Sent / Paid / Cancelled only': 'Csak Elküldve / Fizetve / Törölve',
    'Zero-dollar support': 'Nulla dolláros támogatás',
    'Documented waiver · no invoice': 'Dokumentált mentesség · nincs számla',
    'PDF delivery': 'PDF kézbesítés',
    'Generated from approved ledger': 'Jóváhagyott főkönyvből generálva',
    'Email delivery': 'E-mail kézbesítés',
    'Queued in delivery outbox': 'Kézbesítési kimenő sorba helyezve',
    'Only approved and distributed invoices appear here. Open the HIMATE PDF copy at any time.': 'Itt csak a jóváhagyott és kiküldött számlák jelennek meg. A HIMATE PDF-példány bármikor megnyitható.',
    'Packages': 'Csomagok',
    ...
    'Current VAT rate': 'Aktuális áfakulcs',
    'Edit net price': 'Nettó ár szerkesztése',
    'Entitlement model': 'Jogosultsági modell',
    'Included modules': 'Tartalmazott modulok',
    'Module entitlement': 'Moduljogosultság',
    'Net monthly price': 'Nettó havi ár',
    'Net monthly price (USD)': 'Nettó havi ár (USD)',
    'Package details': 'Csomag részletei',
    'Package prices are net. VAT is added from the HIMATE billing profile at invoice and payment time.': 'A csomagárak nettó árak. Az áfa a HIMATE számlázási profiljában beállított szabály alapján kerül hozzáadásra a számlázás és a fizetés során.',
    'Premium grows automatically': 'A Premium automatikusan bővül',
    'Save net price': 'Nettó ár mentése',
    'Starter includes 10 HIMATE-defined modules, Business includes 20, and Premium provides unlimited access to every current and future eligible module.': 'A Starter 10, a Business 20 HIMATE által meghatározott modult tartalmaz, a Premium pedig korlátlan hozzáférést biztosít minden jelenlegi és jövőbeli jogosult modulhoz.',
    'Unlimited by rule — not by a stored module count': 'Szabály szerint korlátlan — nem tárolt modulszám alapján',
    'VAT rate %': 'Áfakulcs %',
    'VAT jurisdiction': 'Áfa joghatóság',
    'Tax label': 'Adó megnevezése',
    'VAT rate': 'Áfakulcs',
    'Package price basis': 'Csomagár alapja',
    'Net + configured VAT': 'Nettó + beállított áfa',
    'VAT authority': 'Áfa beállítás forrása',
    'Admin billing profile': 'Admin számlázási profil',
    'Set VAT rate to 0 while HIMATE is outside the applicable VAT charging regime. Package prices remain net and checkout adds the configured tax rate.': 'Állítsd az áfakulcsot 0%-ra, amíg a HIMATE nem tartozik az alkalmazandó áfafizetési körbe. A csomagárak nettó árak maradnak, a fizetési folyamat pedig a beállított adókulcsot adja hozzá.',
    'Dashboard': 'Irányítópult',
    'Partners': 'Partnerek',
    'partners': 'partner',
    'assignments': 'hozzárendelés',
    'Modules and their partner companies': 'Modulok és partnercégeik',
    'Partner companies and their active services': 'Partnercégek és aktív szolgáltatásaik',
    'Open a module to see every company using it under the selected status and filters.': 'Nyiss meg egy modult az azt használó összes cég megtekintéséhez a kiválasztott állapot és szűrők szerint.',
    'Open a company to see its assigned modules and commercial state.': 'Nyiss meg egy céget a hozzárendelt moduljai és kereskedelmi állapota megtekintéséhez.',
    'No assignments': 'Nincsenek hozzárendelések',
    'No partner-module assignments match this group.': 'Ehhez a csoporthoz nem tartozik a feltételeknek megfelelő partner–modul hozzárendelés.',
    'Partner': 'Partner',
    ...
    'Operational partner environments': 'Működő partnerkörnyezetek',
    'Pre-license pipeline': 'Licenc előtti folyamat',
    'Reference implementation': 'Referencia-megvalósítás',
    'Reference partners only': 'Csak referenciapartnerek',
    'Store both English and Hungarian business labels for every dynamic category.': 'Minden dinamikus kategóriához tárold az angol és magyar üzleti megnevezést.',
    'Partner category created.': 'Partnerkategória létrehozva.',
    'shown': 'megjelenítve',
    'matched': 'találat',
    'Page': 'Oldal',
    'of': '/',
    'Back to Partners': 'Vissza a Partnerekhez',
    'TEST': 'TESZT',
    'GOLDEN TEST': 'GOLDEN TESZT',
    'TEST DATA · excluded from platform aggregates': 'TESZTADAT · kizárva a platform összesítéseiből',
    'Base + active extra modules': 'Alapdíj + aktív extra modulok',
    'module records': 'modulrekord',
    'Included module entitlements': 'A csomagban foglalt moduljogosultságok',
    'Temporarily restricted modules': 'Ideiglenesen korlátozott modulok',
    'Prospect': 'Érdeklődő',
    'License Pending': 'Licenc függőben',
    'Ready To Provision': 'Provisioningra kész',
    'Configuration': 'Konfiguráció',
    'Testing': 'Tesztelés',
    'Ready For Launch': 'Indításra kész',
    'Live': 'Éles',
    'Suspended': 'Felfüggesztve',
    'Archived': 'Archiválva',
    '1 · Company & legal identity': '1 · Cég- és jogi adatok',
    '2 · Registered office & contacts': '2 · Székhely és kapcsolattartók',
    '3 · Partner Portal & branding': '3 · Partnerportál és arculat',
    '4 · Commercial defaults': '4 · Kereskedelmi alapbeállítások',
    'Billing currency': 'Számlázási pénznem',
    'Billing mode': 'Számlázási mód',
    'Paid': 'Fizetős',
    'Charity': 'Jótékonysági',
    'Complimentary': 'Díjmentes',
    'Charity review status': 'Jótékonysági státusz',
    'Not requested': 'Nincs kérve',
    'Pending review': 'Ellenőrzésre vár',
    'Approved': 'Jóváhagyva',
    'Charity requires HIMATE approval': 'A jótékonysági státusz HIMATE-jóváhagyást igényel',
    'Charity billing mode requires Approved charity status.': 'A jótékonysági számlázási módhoz jóváhagyott jótékonysági státusz szükséges.',
    'Display names do not need to be unique.': 'A megjelenített neveknek nem kell egyedinek lenniük.',
    'Name shown inside HIMATE': 'A HIMATE-ben megjelenő név',
    'Defaults to display name': 'Alapértelmezetten a megjelenített név',
    'Legal company name *': 'Hivatalos cégnév *',
    'Company / registration number *': 'Cég- / nyilvántartási szám *',
    'Tax / VAT ID *': 'Adó- / ÁFA-azonosító *',
    'Country *': 'Ország *',
    'City *': 'Város *',
    'Postal code *': 'Irányítószám *',
    'Registered address line 1 *': 'Bejegyzett cím 1. sora *',
    'Registered address line 2': 'Bejegyzett cím 2. sora',
    'Company phone': 'Céges telefonszám',
    'Portal Owner / primary contact name *': 'Partnerportál-tulajdonos / elsődleges kapcsolattartó neve *',
    'Partner Portal Owner email *': 'Partnerportál-tulajdonos e-mail-címe *',
    'Initial Partner Portal password *': 'Kezdeti Partnerportál-jelszó *',
    'Minimum 12 characters with lowercase, uppercase, number and special character.': 'Legalább 12 karakter kis- és nagybetűvel, számmal és speciális karakterrel.',
    'Finance / billing contact': 'Pénzügyi / számlázási kapcsolattartó',
    'Finance / billing email': 'Pénzügyi / számlázási e-mail',
    'Choose logo': 'Logó kiválasztása',
    'PNG, JPEG or WebP. The asset is stored in the partner-scoped media library and becomes the partner logo reference used by HIMATE and the Partner Portal.': 'PNG, JPEG vagy WebP. A fájl a partnerhez tartozó médiatárba kerül, és a HIMATE valamint a Partnerportál logóhivatkozása lesz.',
    'Internal partner notes': 'Belső partnermegjegyzések',
    'Partner-specific license, provider-backed payment and recurring 30-day terms.': 'Partnerspecifikus licenc, szolgáltató által kezelt fizetés és ismétlődő 30 napos feltételek.',
    'Provisioning remains controlled': 'A provisioning továbbra is ellenőrzött',
    'Create an account scoped only to this partner. Portal roles cannot grant HIMATE control-plane access.': 'Csak ehhez a partnerhez tartozó fiók létrehozása. A portál-szerepkörök nem adhatnak hozzáférést a HIMATE központi vezérlőfelületéhez.',
    'Role or status changes invalidate that partner-user session.': 'A szerepkör- vagy státuszváltozás érvényteleníti az adott partnerfelhasználó munkamenetét.',
    'Create portal user': 'Portálfelhasználó létrehozása',
    'Edit Partner Portal user': 'Partnerportál-felhasználó szerkesztése',
    'Save portal user': 'Portálfelhasználó mentése',
    'Upload commercial document': 'Kereskedelmi dokumentum feltöltése',
    'Choose a file and enter a document name.': 'Válassz fájlt és add meg a dokumentum nevét.',
    'The file is stored in HIMATE Evidence/Storage first, checksum-verified, then linked to Billing.': 'A fájl először a HIMATE Evidence/Storage rendszerbe kerül, ellenőrzőösszeggel hitelesítve, majd a Billinghez kapcsolódik.',
    'Upload and register': 'Feltöltés és rögzítés',
    'Golden Test Partner': 'Golden tesztpartner',
    'Built-in partner categories are available': 'A beépített partnerkategóriák elérhetők',
    'A previous partner onboarding is still incomplete. Retry after the dependent service recovers.': 'Egy korábbi partner-beállítás még nem fejeződött be. Próbáld újra, miután a függő szolgáltatás helyreállt.',
    'Create the complete partner master record, billing identity, first Portal Owner and initial brand identity. Provisioning can be completed from the partner workspace.': 'Hozd létre a teljes partner törzsadatot, számlázási identitást, az első portáltulajdonost és a kezdeti arculatot. A provisioning a partner munkaterületéről fejezhető be.',
    ...
    'Partner Portal Access': 'Partnerportál-hozzáférés',
    'No Partner Portal user yet': 'Még nincs Partnerportál-felhasználó',
    'Tenant-scoped partner identities. These users can never inherit HIMATE platform-administrator authority.': 'Partnerhez kötött felhasználói identitások. Ezek a felhasználók soha nem örökölhetnek HIMATE platform-adminisztrátori jogosultságot.',
    ...
    'Name, organization, type, topic, email or message': 'Név, szervezet, típus, téma, e-mail vagy üzenet',
    'Organization type': 'Szervezet típusa',
    'Inquiry topic': 'Megkeresés témája',
    'Classical Music': 'Klasszikus zene',
    'Fine Art': 'Képzőművészet',
    'Gallery': 'Galéria',
    'Theatre': 'Színház',
    'Cultural Organization': 'Kulturális szervezet',
    'Piano Technology': 'Zongoratechnika',
    'Museum': 'Múzeum',
    'Foundation': 'Alapítvány',
    'Creative Network': 'Kreatív hálózat',
    'Partnership': 'Partnerség',
    'Platform Demo': 'Platformbemutató',
    'Pricing Licensing': 'Árazás és licencelés',
    'Charity Sponsorship': 'Jótékonyság / támogatás',
    'Technical': 'Technikai kérdés',
    'Other': 'Egyéb',
    'Inquiry': 'Megkeresés',
    ...
    'Search partners, modules, contacts, CMS and administration...': 'Keresés partnerek, modulok, kapcsolatok, CMS és adminisztráció között...',
    'Search is temporarily unavailable': 'A keresés átmenetileg nem érhető el',
    'Type at least two characters. Results are restricted to workspaces you are allowed to read.': 'Írj be legalább két karaktert. Csak azokból a munkaterületekből jelennek meg találatok, amelyekhez olvasási jogosultságod van.',
    'No permitted results found.': 'Nem található engedélyezett találat.',
    'Result workspace': 'Találat munkaterülete',
    'No paid revenue recorded this year': 'Idén még nincs rögzített kifizetett bevétel',
    'Paid activation + recurring revenue': 'Kifizetett aktiválási és ismétlődő bevétel',
    'Mixed': 'Vegyes',
    'Restricted': 'Korlátozott',
    'Billing permission required': 'Pénzügyi olvasási jogosultság szükséges',
    'Impact permission required': 'Hatásadat-olvasási jogosultság szükséges',
    'Verified attendance metric · YTD': 'Hitelesített látogatottsági mérőszám · YTD',
    'Live audit feed': 'Élő auditfolyam',
    'No permitted recent activity.': 'Nincs megjeleníthető legutóbbi tevékenység.',
    'System activity': 'Rendszertevékenység',
    ...
    'Loading package analytics': 'Csomaganalitika betöltése',
    'Monthly package price': 'Havi csomagár',
    'No package analytics yet': 'Még nincs csomaganalitika',
    'No partner subscriptions recorded': 'Nincs rögzített partner-előfizetés',
    'Package Analytics': 'Csomaganalitika',
    'Package analytics is temporarily unavailable': 'A csomaganalitika átmenetileg nem érhető el',
    'Package distribution & usage': 'Csomageloszlás és használat',
    'Package price must be zero or greater.': 'A csomagárnak legalább nullának kell lennie.',
    'Packages could not be loaded': 'A csomagok nem tölthetők be',
    'Partner distribution, package usage, Portal activity and current commercial context from authoritative runtime data.': 'Partnereloszlás, csomaghasználat, Portal-aktivitás és aktuális kereskedelmi kontextus hiteles futásidejű adatokból.',
    'Partner package usage': 'Partner csomaghasználat',
    'Portal active-time measurement has just been enabled': 'A Portal aktív idő mérését most engedélyeztük',
    'Price effective date': 'Ár hatálybalépési dátuma',
    'Required for commercial audit trail': 'A kereskedelmi auditnaplóhoz kötelező',
    'Retry': 'Újrapróbálás',
    'Starter, Business and Premium package control with usage and commercial analytics.': 'Starter, Business és Premium csomagkezelés használati és kereskedelmi analitikával.',
    'YYYY-MM-DD · blank = today': 'ÉÉÉÉ-HH-NN · üresen hagyva: ma',
    'All': 'Összes',
    'Business': 'Business',
    'No paid revenue in this view': 'Ebben a nézetben nincs fizetett árbevétel',
    'Package': 'Csomag',
    'Paid partners continue through invoice and payment. Charity, Sponsored and Complimentary partners use documented zero-dollar support instead of an invoice.': 'A fizető partnerek számlázáson és fizetésen haladnak tovább. A Charity, Sponsored és Complimentary partnerek dokumentált, nulla dolláros támogatást használnak számla helyett.',
    'Partner onboarding, invoice approval, payment status and auditable finance controls. A partner reaches Portal access only after final HIMATE approval.': 'Partner onboarding, számlajóváhagyás, fizetési státusz és auditálható pénzügyi vezérlés. A Partner Portal csak a végső HIMATE-jóváhagyás után válik elérhetővé.',
    'Premium': 'Premium',
    'Save classification': 'Besorolás mentése',
    'Starter': 'Starter',
    'Dynamic business metrics store English and Hungarian labels and descriptions independently.': 'A dinamikus üzleti metrikák az angol és magyar címkéket és leírásokat külön tárolják.',
  ...
  static const Map<String, String> _completionHu = <String, String>{
    ...
    'Previous partner onboarding could not be resumed yet': 'A korábbi partner-beállítás még nem folytatható',
    'Partner registration needs attention': 'A partnerregisztráció figyelmet igényel',
    'Registration is not complete yet': 'A regisztráció még nem teljes',
    'Creating partner…': 'Partner létrehozása…',
    'Completing setup…': 'Beállítás befejezése…',
    'Create partner': 'Partner létrehozása',
    'Retry setup': 'Beállítás újrapróbálása',
    'Partner could not be created': 'A partner nem hozható létre',
    'exists, but onboarding is not complete.': 'létezik, de a beállítása még nem teljes.',
    'Correct the data or service issue and press Retry setup. This window will stay open.': 'Javítsd az adat- vagy szolgáltatáshibát, majd válaszd a Beállítás újrapróbálása lehetőséget. Ez az ablak nyitva marad.',
    'Provisioning could not complete': 'A provisioning nem fejezhető be',
    'Portal user could not be created': 'A portálfelhasználó nem hozható létre',
    'Portal user could not be updated': 'A portálfelhasználó nem frissíthető',
    'Credential operation failed': 'A hitelesítőadat-művelet sikertelen',
  ...
  static const Map<String, String> _start23Hu = <String, String>{
    ...
    'Module Marketplace': 'Modul piactér',
    'MODULE CATALOG': 'MODULKATALÓGUS',
    'Catalog modules': 'Katalógusmodulok',
    'Visible in Module Marketplace': 'Látható a Modul piactéren',
    'Included': 'Tartalmazza',
    'Locked': 'Zárolt',
    'Coming soon': 'Hamarosan',
    'Included in your plan': 'A csomagod része',
    'Explore more modules': 'További modulok felfedezése',
    'Temporarily unavailable': 'Átmenetileg nem elérhető',
    'View upgrade options': 'Csomagváltási lehetőségek',
    'Plan access': 'Csomag-hozzáférés',
    'Live availability': 'Éles elérhetőség',
    'Discovery only': 'Csak megtekinthető',
    'READY + PUBLISHED': 'KÉSZ + PUBLIKÁLT',
    'This module is not available with your current subscription.': 'Ez a modul a jelenlegi előfizetéseddel nem érhető el.',
    'This module is included in your current subscription and is available to your organization.': 'Ez a modul a jelenlegi előfizetésed része, és a szervezeted számára elérhető.',
    'This canonical HIMATE module is visible for discovery, but live access is not available until its implementation is READY and PUBLISHED.': 'Ez a hivatalos HIMATE modul már megtekinthető, de éles hozzáférés csak akkor lesz elérhető, amikor az implementáció KÉSZ és PUBLIKÁLT.',
    'This module is currently unavailable for live use.': 'Ez a modul jelenleg nem érhető el éles használatra.',
    'No live modules in the current plan': 'Nincs éles modul a jelenlegi csomagban',
    'The complete module catalog remains visible below.': 'A teljes modulkatalógus továbbra is látható alább.',
    'No additional live modules are locked': 'Nincs további zárolt éles modul',
    'Your current subscription already covers every live module available to you.': 'A jelenlegi előfizetésed már tartalmaz minden számodra elérhető éles modult.',
    ...
    'Module': 'Modul',
    'Active Modules': 'Aktív modulok',
    'Add dependency, integration, extension, conflict or replacement relations.': 'Adj hozzá függőségi, integrációs, kiterjesztési, ütközési vagy helyettesítési kapcsolatokat.',
    'Add module relationship': 'Modulkapcsolat hozzáadása',
    'Adjust the filters or create partners/modules to populate the commercial matrix.': 'Módosítsd a szűrőket, vagy hozz létre partnereket/modulokat a kereskedelmi mátrix feltöltéséhez.',
    'Back to Modules': 'Vissza a Modulokhoz',
    'Back to module topics': 'Vissza a modultémákhoz',
    'Bilingual business metadata, source identity, artifact reference and compatibility.': 'Kétnyelvű üzleti metaadatok, forrásazonosító, artifact-hivatkozás és kompatibilitás.',
    'Browse': 'Megnyitás',
    'Canonical + custom modules': 'Kanonikus + egyedi modulok',
    'Commercial Control': 'Kereskedelmi vezérlés',
    'Configured modules': 'Beállított modulok',
    'Create a stable registry classification with independent English and Hungarian labels.': 'Hozz létre stabil registry-besorolást külön angol és magyar megnevezéssel.',
    'Create group': 'Csoport létrehozása',
    'Create module group': 'Modulcsoport létrehozása',
    'Current entitlement plus real runtime frequency from successful Partner Portal module operations.': 'Aktuális jogosultság és a sikeres Partnerportál-modulműveletekből származó valós használati gyakoriság.',
    'Customer-selected package': 'Ügyfél által összeállított csomag',
    'Edit module': 'Modul szerkesztése',
    'Flex customers choose up to 15 published modules. HIMATE does not define a fixed Flex module set.': 'A Flex ügyfelek legfeljebb 15 publikált modult választhatnak. A HIMATE nem határoz meg fix Flex modulkészletet.',
    'Git/source identity configured': 'Git/forrásazonosító beállítva',
    'IN DEVELOPMENT': 'FEJLESZTÉS ALATT',
    'Impact Mapping': 'Hatásmutató-kapcsolás',
    'Impact metric mapping': 'Hatásmutatók hozzárendelése',
    'Included in base': 'Az alapcsomag része',
    'LEGACY REFERENCE': 'LEGACY REFERENCIA',
    'MODULE CONTROL PLANE': 'MODUL VEZÉRLŐKÖZPONT',
    'Map existing Impact metric keys to this module.': 'Rendelj meglévő Impact-mutatókulcsokat ehhez a modulhoz.',
    ...
    'Module detail unavailable': 'A modul részletei nem érhetők el',
    'Module registry': 'Modul-registry',
    'Modules': 'Modulok',
    'Modules participating in dependency, integration, extension, conflict or replacement relationships.': 'Függőségi, integrációs, kiterjesztési, ütközési vagy helyettesítési kapcsolatokban részt vevő modulok.',
    'Modules with an authoritative Git/source identity configured.': 'Authoritative Git/forrásazonosítóval rendelkező modulok.',
    'Move to': 'Áthelyezés ide:',
    'No impact metrics mapped': 'Nincs hozzárendelt hatásmutató',
    'No modules found': 'Nem található modul',
    'No modules match the current topic or filters.': 'Egy modul sem felel meg az aktuális témának vagy szűrőknek.',
    'No partner usage yet': 'Még nincs partnerhasználat',
    'No relationships yet': 'Még nincs kapcsolat',
    'One metric per line. Optional label can follow a | separator.': 'Soronként egy mutató. Opcionális megnevezés a | elválasztó után adható meg.',
    'Open a topic to see its modules. Module cards can be moved to another topic from their action menu.': 'Nyiss meg egy témát a moduljai megtekintéséhez. A modulkártyák a műveleti menüből másik témába helyezhetők.',
    'Open details': 'Részletek megnyitása',
    'Partner Usage': 'Partnerhasználat',
    'Partner-specific assignment, recurring price, activation fee and subscription state remain available without dominating the registry view.': 'A partnerspecifikus hozzárendelés, ismétlődő díj, aktiválási díj és előfizetési állapot továbbra is elérhető anélkül, hogy uralná a registry nézetet.',
    'Pilot pricing authority': 'Pilot árazási referencia',
    'READY + PUBLISHED for live assignment': 'READY + PUBLISHED, éles hozzárendelésre kész',
    'READY + PUBLISHED modules currently available for live assignment.': 'Jelenleg éles hozzárendelésre elérhető READY + PUBLISHED modulok.',
    'Recorded in partner-module commercial history': 'Rögzítve a partner-modul kereskedelmi előzményekben',
    'Register a dependency or integration relation.': 'Függőségi vagy integrációs kapcsolat rögzítése.',
    'Relationship Graph': 'Kapcsolati gráf',
    'Relationships': 'Kapcsolatok',
    'Runtime uses · 30 days': 'Runtime használat · 30 nap',
    'Runtime uses · 7 days': 'Runtime használat · 7 nap',
    ...
    'Source Linked': 'Forráshoz kapcsolt',
    'Source linked': 'Forráshoz kapcsolt',
    'Starter and Business use fixed HIMATE-defined packages. Flex gives the customer up to 15 selectable modules.': 'A Starter és Business fix, HIMATE által meghatározott csomagokat használ. A Flex legfeljebb 15 választható modult biztosít.',
    'Starter: USD 500/month · Business: USD 1,500/month · Flex: USD 2,500/month. Individual module prices remain stored for future add-ons/custom contracts but do not drive standard plan invoices.': 'Starter: 500 USD/hó · Business: 1 500 USD/hó · Flex: 2 500 USD/hó. Az egyedi modulárak megmaradnak jövőbeli kiegészítésekhez/egyedi szerződésekhez, de nem ezek vezérlik a standard csomagszámlázást.',
    'Subscription Plans': 'Előfizetési csomagok',
    'The module has not been initialized for a partner.': 'A modult még egyetlen partnerhez sem inicializálták.',
    'The selected module is the source node; each card shows a directed relation.': 'A kiválasztott modul a forráscsomópont; minden kártya egy irányított kapcsolatot mutat.',
    'Topic modules. Open a card for usage, dependencies and impact details.': 'A téma moduljai. Nyiss meg egy kártyát a használati, függőségi és impact részletekhez.',
    'Topic-driven module registry, partner usage and commercial control in one authoritative workspace.': 'Téma-alapú modul-registry, partnerhasználat és kereskedelmi vezérlés egy authoritative munkaterületen.',
    'active partner assignments': 'aktív partner-hozzárendelés',
    'active partners': 'aktív partner',
    'in development': 'fejlesztés alatt',
    'live ready': 'élesre kész',
    'modules': 'modul',
    'remaining': 'maradt',
    'topics': 'téma',
    'Commercial Matrix': 'Kereskedelmi mátrix',
    'Hide Commercial Matrix': 'Kereskedelmi mátrix elrejtése',
    'Hide matrix': 'Mátrix elrejtése',
    'Open matrix': 'Mátrix megnyitása',
    'Default 30-day price': 'Alapértelmezett 30 napos díj',
    'Default activation fee': 'Alapértelmezett aktiválási díj',
    'Reference module price': 'Referencia modulár',
    'Reference activation fee': 'Referencia aktiválási díj',
    'Billing authority': 'Számlázási jogosultság forrása',
    'Publication status': 'Publikációs állapot',
    'Implementation state': 'Implementációs állapot',
    'Operational availability': 'Működési elérhetőség',
    'Legacy/reference implementation': 'Legacy/referencia implementáció',
    'Contract currency': 'Szerződés pénzneme',
    'Quote / offer reference': 'Árajánlat / ajánlat hivatkozása',
    'Partner-specific commercial offer': 'Partner-specifikus kereskedelmi ajánlat',
    'Individual activation fee · USD': 'Egyedi aktiválási díj · USD',
    'Individual base monthly fee · USD': 'Egyedi havi alapdíj · USD',
    'Minimum monthly commitment · USD': 'Minimum havi vállalás · USD',
    'Partner-specific offer reference': 'Partner-specifikus ajánlati hivatkozás',
    'Individual base service fee': 'Egyedi alap szolgáltatási díj',
    'Minimum monthly commitment': 'Minimum havi vállalás',
    'Quote / offer': 'Árajánlat / ajánlat',
    'Terms version': 'Kereskedelmi feltételek verziója',
    'Contract price': 'Szerződéses ár',
    'Pricing authority': 'Árazás jogosultsági forrása',
    ...
    'Configure how the existing partner website connects to HIMATE. This does not replace or reprogram the partner website.': 'Állítsd be, hogyan kapcsolódjon a partner meglévő weboldala a HIMATE-hez. Ez nem cseréli le és nem programozza újra a partner weboldalát.',
    'Configured': 'Beállítva',
    'No website rewrite': 'Nincs weboldal-újraírás',
    'Privacy mode': 'Adatvédelmi mód',
    'Database, media and configuration are captured, encrypted and copied to the configured durable backup storage.': 'Az adatbázis, a média és a konfiguráció rögzítésre, titkosításra és a beállított tartós biztonsági mentési tárhelyre másolásra kerül.',
    'Connector credential': 'Connector hitelesítőadat',
    'Generate or rotate a partner-scoped credential. The raw secret is displayed exactly once.': 'Partnerhez kötött hitelesítőadat létrehozása vagy cseréje. A nyers titok pontosan egyszer jelenik meg.',
    'Generate credential': 'Hitelesítőadat létrehozása',
    'Store this credential now': 'Mentsd el most ezt a hitelesítőadatot',
    'For security, HIMATE stores only the token hash. This raw credential will not be shown again.': 'Biztonsági okból a HIMATE csak a token hashét tárolja. Ez a nyers hitelesítőadat nem jelenik meg újra.',
    'Credential copied.': 'Hitelesítőadat másolva.',
    'I stored it securely': 'Biztonságosan elmentettem',
    'Move the partner to READY TO PROVISION before starting provisioning.': 'A provisioning indítása előtt állítsd a partnert READY TO PROVISION állapotba.',
    'Provisioning completed or resumed successfully.': 'A provisioning sikeresen befejeződött vagy folytatódott.',
    'Manage hostname, platform release and deployment/environment state.': 'A hostname, a platform release és a deployment/környezet állapotának kezelése.',
    'Save environment': 'Környezet mentése',
    'Close': 'Bezárás',
  };
