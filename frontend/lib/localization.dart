...
class HimateI18n {
  ...
  static const Map<String, String> _literalHu = <String, String>{
    ...
    'Default monthly reference price': 'Alapértelmezett havi referenciaár',
    ...
    'Partner monthly price': 'Partner havi ára',
    ...
    'Paid-period deactivation is Billing-managed. Use Cancel at period end; access remains active until the current calendar month closes.': 'A kifizetett időszak kikapcsolását a számlázási rendszer kezeli. Használd az időszak végi lemondást; a hozzáférés az aktuális naptári hónap végéig aktív marad.',
    'Paid-period deactivation is Billing-managed. Use Cancel at period end; access remains active until the current 30-day period closes.': 'A kifizetett időszak kikapcsolását a számlázási rendszer kezeli. Használd az időszak végi lemondást; a hozzáférés a korábbi 30 napos időszak végéig aktív marad.',
    ...
    'Automatic calendar-month collection': 'Automatikus naptári havi díjbeszedés',
    'Partner-specific license, provider-backed payment and calendar-month terms.': 'Partnerspecifikus licenc, szolgáltatói fizetés és naptári havi feltételek.',
    'A calendar-month subscription record is created when the active module is synchronized.': 'Az aktív modul szinkronizálásakor naptári havi előfizetési rekord jön létre.',
    'Calendar month · full monthly charge · no proration': 'Naptári hónap · teljes havi díj · nincs időarányosítás',
    'Automatic 30-day collection': 'Automatikus 30 napos díjbeszedés (korábbi megnevezés)',
  ...
  static const Map<String, String> _completionHu = <String, String>{
    ...
    'Control entitlement, partner visibility and calendar-month pricing without removing the underlying module code or data.': 'A jogosultság, partnerláthatóság és naptári havi árazás kezelése az alapul szolgáló modulkód vagy adatok eltávolítása nélkül.',
  ...
  static const Map<String, String> _start23Hu = <String, String>{
    ...
    'Current calendar month': 'Aktuális naptári hónap',
    ...
    'Every calendar month': 'Minden naptári hónapban',
    ...
    'Partner monthly price': 'Partner havi díja',
    ...
    'Configured monthly price': 'Beállított havi díj',
