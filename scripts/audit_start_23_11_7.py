...
checks=[
 ...
 ("Partner Portal gateway routes every principal frontend domain",
  all(token in gateway for token in [
    'path=="/partner/api/v1/dashboard"',
    'path=="/partner/api/v1/company"',
    'path=="/partner/api/v1/modules"',
    'path=="/partner/api/v1/users"',
    'strings.HasPrefix(path,"/partner/api/v1/notifications")',
    'path=="/partner/api/v1/design"',
    'path=="/partner/api/v1/design/workspace"',
  ])),
